...
namespace NCase.Persistence.Migrations
{
    ...
    [Migration("20240904134359_mig_3")]
    partial class mig_3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NCase.Domain.Entities.Character.Character", b =>
                {
                    b.HasOne("NCase.Domain.Entities.Character.Episode", null)
                        .WithMany("Characters")
                        .HasForeignKey("EpisodeId");

                    b.HasOne("NCase.Domain.Entities.Character.Location", "Location")
                        .WithMany("Residents")
                        .HasForeignKey("LocationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("NCase.Domain.Entities.Character.Location", "Origin")
                        .WithMany()
